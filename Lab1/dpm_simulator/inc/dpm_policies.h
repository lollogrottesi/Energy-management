...
#define DPM_HIST_WIND_SIZE 8 //moved from 5 to 8.
/** number of thresholds for history-based policies */
#define DPM_N_THRESHOLDS 2
/** @} */
//Timeout value for a non defined timeout.
#define TIMEOUT_NOT_DEFINED -1.0 
/**
 ...
 *
 */
double dpm_update_history(psm_interval_t *h, psm_interval_t new_idle);
