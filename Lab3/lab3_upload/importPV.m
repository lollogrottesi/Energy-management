function PV = importPV(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   PVRED = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   PVRED = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PVred = importfile('PV_red.txt', 2, 31);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/01/12 11:47:05
